            ...
            <section id="mainWork">
                <div class="container text-center h-100">
                    <div class="row gy-2 gx-2 align-items-center h-100">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <a type="button" href="#buyOptions" id="workScrollDownBtn" class="btn btn-lg rounded-5 shadow-sm fw-medium fs-2 mx-auto d-flex flex-row align-items-center justify-content-center gap-2"
        ...
        return `
            <ul class="nav nav-pills nav-fill px-0 gap-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-5 fs-2 fw-medium shadow-sm" aria-current="page" data-bs-toggle="tab" data-bs-target="#englishOptions" type="button" role="tab"
                    aria-controls="englishOptions" aria-selected="true" id="forEnglish">For Learning English</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5 fs-2 fw-medium shadow-sm" data-bs-toggle="tab" data-bs-target="#programmingOptions" type="button" role="tab"
                    aria-controls="programmingOptions" aria-selected="false" id="forProgramming">For Web Development</button>
                </li>
            </ul>
        `;
    }
